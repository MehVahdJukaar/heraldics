...
public class ModRenderTypes extends RenderType {
    ...
    public static final Function<ResourceLocation, RenderType> ARMOR_PATTERN_LAYER = Util.memoize(texture -> {
        ...
        return create("heraldics_armor_pattern_layer", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS,
                1536, false, true, state);
    });

    public static RenderType armorPatternLayer(Identifier texture) {
